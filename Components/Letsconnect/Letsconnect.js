      ...
      <div className={styles.connect_background}>
        <div className="col-md-12 text-center display_h pt-5 pb-4 ">
          <div className="col-md-12">
            ...
            <button onClick={() => contactus()} className="btn btn-dark px-5 background_button_dark animated_button_banner bg-dark text-light py-2 px-5 mb-4">Contact Us</button>
          </div>
        </div>
